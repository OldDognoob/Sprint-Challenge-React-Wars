...
- [ ] What does it mean to _think_ in react?
 ...
 For every developer to _think_ in react means that he needs to break in pieces each part of the User
 Interface into components,like example having a navigation , main section, bottom section or footer.It is the way of building web apps.
 In other way it means thinking components.
...
Props is the way of passing data from one component to another component.
